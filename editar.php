...
<form id="crear" action="" method="post">
   ...
   <button type="submit" class="btn btn-primary" onclick="actualizar()">Aceptar</button>
</form>
        </div>
    </div>
 <!-- Modal -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edición Exitosa</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        El postre se ha editado correctamente
      </div>
      <div class="modal-footer">
        
        <a class="btn btn-primary" href="index.php" role="button" data-dismiss="modal">Link</a>
      </div>
    </div>
  </div>
</div>
...
if (!user) {
  ...
  var dataDB = firebase.database().ref('postres');
 
 var userId= window.name;

    var nombre, precio, stock;
    var postre={};
